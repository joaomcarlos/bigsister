...
namespace Magic
{
    ...
    /// </summary>
    public static class CopyOfWaitValues
    {
        /// <summary>
    ...
    /// <summary>
    /// Used for VirtualQueryEx / VirtualQuery
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
	...
	public static class Imports
	{
        ...
        /// </summary>
        /// <param name="threadId"> Identifier of the thread to which the message is to be posted.
        ...
        /// </summary>
        /// <param name="lpFileName">The name of the module. 
        /// This can be either a library module (a .dll file) or an executable module (an .exe file). 
        /// The name specified is the file name of the module and is not related to the name stored in the library module itself, as specified by the LIBRARY keyword in the module-definition (.def) file.</param>
        /// <returns></returns>
        [DllImport("kernel32")]
        ...
        /// <returns>Passing a kernel-mode pointer to this function can result in no information being returned, due to security issues. In this case, the return value is zero.</returns>
